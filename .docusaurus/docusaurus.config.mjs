...
export default {
  ...
  "organizationName": "goncalo22",
  "projectName": "SkyrimNet-GamePlugin",
  "onBrokenLinks": "warn",
  ...
  "plugins": [
    [
      "@docusaurus/plugin-content-docs",
      {
        ...
        "path": "docs",
        "routeBasePath": "/",
        "sidebarPath": "C:\\Users\\G\\skyrimnet-docs\\sidebars.ts",
  ...
  "themeConfig": {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2025 SkyrimNet, Inc. Built with Docusaurus."
    },
    "prism": {
      "theme": {
        "plain": {
